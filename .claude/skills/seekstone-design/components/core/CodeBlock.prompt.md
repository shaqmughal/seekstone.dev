...
```jsx
<CodeBlock prompt code="npx -y seekstone init" />
...
- Copy is on by default and shows a green "Copied" confirmation. Keep commands copy-paste-ready (the canonical install is `npx -y seekstone`).
